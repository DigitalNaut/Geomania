...
export default function RegionsToggleOverlay({ onClick }: { onClick: (id: string) => void }) {
  ...
  return (
    <motion.div
      ...
      exit="initial"
    >
      <div className="absolute inset-1/2 z-1000 mx-auto flex size-max max-w-(--breakpoint-sm) -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-2 rounded-md bg-sky-900/70 p-3 shadow-md backdrop-blur-md hover:bg-sky-900">
