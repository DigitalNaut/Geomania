...
import { clip, outCountryFeatures, outMapContinents, outMapCountries, proj, shapeFile } from "./setup.js";
...
async function processMaps() {
  ...
  const continentsMap = runCommand(continentsCmd, "Generating continent map").then(() =>
  ...
  try {
    ...
    // End with a filled square symbol
