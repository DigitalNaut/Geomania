...
const countriesCmd = `mapshaper "${shapeFile}"
                      ...
                      -each expression="
                        ...
                        if(!['Oceania', 'Europe'].includes(this.properties.CONTINENT)) return this.geojson = this.geojson;
                      ...
                      -each expression="
                        if(this.isNull) return;
                        if(!['Oceania', 'Europe'].includes(this.properties.CONTINENT)) return this.properties = this.properties;
...
const subregionsCmd = `mapshaper "${shapeFile}"
                      -clip bbox2=-180,-85,180,85
